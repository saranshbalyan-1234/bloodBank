...
class RequestDonor extends Model
{
    ...
    public $table = "request_donors";
     protected $fillable = [
        'name','email',
'age','gender','blood_type','district','unit','city','state','date_required','phone','hospital_district','hospital_city','hospital_state','hospital_phone','hospital_name','user_id'
    ];
